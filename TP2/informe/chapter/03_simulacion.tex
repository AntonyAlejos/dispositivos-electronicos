...
A partir de las curvas obtenidas en polarización directa se observó que ambos diodos presentan un comportamiento aproximadamente lineal en gran parte del rango analizado, en lugar de la respuesta exponencial ideal esperada teóricamente. Esto se debe principalmente a la resistencia de 1k$\Omega$ conectada en serie con el diodo, la cual limita la corriente del circuito y hace que la relación entre tensión y corriente tienda a ser aproximadamente lineal para el rango de tensiones utilizado.

Además, se observó que el diodo 1N60 comienza a conducir corriente para tensiones menores que el 1N4007, mientras que el 1N4007 requiere una tensión mayor para comenzar a conducir de manera apreciable.
...
\end{axis}
\end{tikzpicture}
\caption{Comparación de curvas características}
\end{figure}
