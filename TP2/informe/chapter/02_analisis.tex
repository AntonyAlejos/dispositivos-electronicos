...
\begin{array}{|c|c|c|}
\hline
\textbf{Parámetro} & \textbf{1N4007} & \textbf{1N60} \\
\hline
V_{RRM} & 1000V & 45V \\
\hline
V_{RSM} & 700V & 50V \\
...
\begin{itemize}
    ...
    Es la tensión inversa a partir de la cual el diodo entra en ruptura.  
    \item $I_R$: Corriente inversa.  
    Es la pequeña corriente que circula cuando el diodo está polarizado en inversa.  
    \item $V_F$: Tensión directa.  
    Representa la caída de tensión del diodo cuando conduce en polarización directa.  
    \item $I_{RM}$: Corriente inversa máxima.  
    Máxima corriente inversa permitida sin comprometer el funcionamiento del dispositivo.  
    \item $I_F$: Corriente directa.  
    Corriente que circula por el diodo cuando está polarizado en directa.  
...
\textbf{Parámetro} & \textbf{1N4007} & \textbf{1N60} \\
\hline
T_J & 150^\circ C & 75^\circ C \\
\hline
T_{STG} & -65^\circ C \text{ a } 150^\circ C & -55^\circ C \text{ a } 100^\circ C \\
\hline
T_A & 25^\circ C & 25^\circ C \\
\hline
R_{\theta JC} & 20^\circ C/W & 200^\circ C/W \\
\hline
\end{array}
\]
...
\begin{array}{|c|c|c|}
\hline
\textbf{Parámetro} & \textbf{1N4728} & \textbf{1N4764} \\
\hline
V_{RMS} & 3.3V & 100V \\
\hline
P_{tot} & 1W & 1W \\
\hline
T_{rr} & \text{No especificado} & \text{No especificado} \\
\hline
\end{array}
\]